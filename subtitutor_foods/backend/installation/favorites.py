...
class InstallationFavorites:
    ...
    def create_table_fav(self, cursor, cnx):
        ...
        create_table_fav = ("CREATE TABLE IF NOT EXISTS Favoris ( id INT UNSIGNED NOT NULL AUTO_INCREMENT, id_produit " 
                           "BIGINT UNSIGNED NOT NULL, id_substitut BIGINT UNSIGNED NOT NULL, date_enregistrement " 
